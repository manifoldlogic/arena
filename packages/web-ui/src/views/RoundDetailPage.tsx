...
export function RoundDetailPage() {
  ...
  if (loading) {
    return <p className="text-sm text-muted-foreground py-8">Loading round data...</p>;
  }

  if (!group) {
    return (
      <div className="py-12 text-center">
        <p className="text-muted-foreground mb-4">Round not found: {id}</p>
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        <section>
          <h2 className="text-lg font-semibold text-foreground mb-4">Dimension Radar</h2>
          <DimensionRadar series={radarSeries} />
        </section>

        <section>
          <h2 className="text-lg font-semibold text-foreground mb-4">Score Comparison</h2>
      ...
      {/* Efficiency */}
      <section>
        <h2 className="text-lg font-semibold text-foreground mb-4">Efficiency</h2>
      ...
      {isBridge && (
        <section>
          <h2 className="text-lg font-semibold text-foreground mb-4">Bridge Deltas</h2>
      ...
      {/* Judge Notes */}
      <section>
        <h2 className="text-lg font-semibold text-foreground mb-4">Judge Notes</h2>
